  ...
  const agentNames = [
   ...
   const handleDateChange = (value) => {
                            ...
                            <div className="card-body">
                              <div className='row'>
                                    ...
                                    <div className="flex justify-start items-center gap-10 !mt-5">
                                        ...
                                        <div>
                                            <SearchableSelect options={[{value:'Done', label:'Done'}, {value:'Pending', label:'Pending'}, {value:'Reject', label:'Reject'}]} onChange={(value)=>setKycFilter(value.label)}  placeholder={'KYC Filter'}></SearchableSelect>
                                        </div>
    ...
    {user.documents ? (
        ...
        <>
            {user.approved == 50 && (
                <p className="px-1 py-2 mb-0 w-content bg-gray-100 rounded-full text-center text-green-400">Approved</p>
            )}
            {user.approved == 51 && (
                <p className="px-1 py-2 mb-0 w-content bg-gray-100 rounded-full text-center text-red-400">Reject</p>
            )}
          {!user.approved || (user.approved != 51 && user.approved != 50) ? (
